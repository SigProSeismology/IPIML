...
#build_taup_model("ynvel.nd")
#model = TauPyModel(model="ynvel")
...
with open("ttdb.txt", "w") as f:
    ...
    for dep in range(0,800,5): # search 0 - 20 km in depth
        for dist in range(1,100,1): # search 0.01 - 1 degree in horizontal 
            dist = dist*0.01
            print(dep,dist)
