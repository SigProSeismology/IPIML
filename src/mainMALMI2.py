...
class MALMI:
    ...
    def __init__(self,   cfgs={}):
        ...
        # %% seismic parameters========================================================
        seismic = {}
        seismic['dir'] = task_dir + cfgs['MIL']['control']['dir_output']+'/data_ML/primary_events' # path to the SDS archive directory or parent directory where seismic data are stored all in one folder
        seismic['instrument_code'] = cfgs['MIL']['seismic']['instrument_code']  # used instrument code of the input seismic data
        ...
        control['n_processor'] = cfgs['MIL']['control']['n_processor']  # number of CPU processors for parallel processing
